...
import 'package:invoice_app_sih/service/auth_service.dart';
import 'package:invoice_app_sih/service/user_service.dart';
...
class AuthController extends GetxController {
  ...
  void checkVerification() async {
    ...
    if (user.emailVerified) {
      ...
      update();
      Get.offAllNamed(Routes.homeScreen);
      EasyLoading.showSuccess('Welcome to Invoice App');
    } else {
      try {
